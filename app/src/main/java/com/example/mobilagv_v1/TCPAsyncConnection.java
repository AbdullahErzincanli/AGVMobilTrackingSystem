 ...
 *
 */
public class TCPAsyncConnection extends android.os.AsyncTask<Void, String, Exception> {
    private String IP;
    private int port;
    private int timeout;
    ...
    public TCPAsyncConnection(String IP, int port, int timeout, ConnectionHandler connectionHandler) {
        this.IP = IP;
        this.port = port;
